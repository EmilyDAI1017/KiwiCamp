...
function MyCampers() {
  ...
  return (
    <div className="main-content">
      <h1 className="text-xl font-bold mb-4">View Registered Campers</h1>
        ...
        {Object.keys(groupedCampers).length === 0 ? (
          ...
          Object.keys(groupedCampers).map((group, idx) => (
            <div key={idx} className="group-section mb-8">
              ...
              <h3 className="text-md font-semibold mb-2">Youth Campers</h3>
              ...
              <h3 className="text-md font-semibold mb-2">Adult Leaders</h3>
