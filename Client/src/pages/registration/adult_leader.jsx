...
return(
    ...
    <form className="space-y-4 " onSubmit={handleSubmit}> 
            ...
            <button onClick={handleFormSubmit} type="submit"             className="w-full mb-4 py-2 bg-green-600 hover:bg-green-700 text-white font-bold rounded-lg focus:outline-none focus:shadow-outline transform hover:scale-105 transition duration-300 ease-in-out"
...
>Register</button>
        ...
        <button
            className="w-full mt-3 mb-2 py-2 bg-green-600 hover:bg-green-700 text-white font-bold rounded-lg focus:outline-none focus:shadow-outline transform hover:scale-105 transition duration-300 ease-in-out"
