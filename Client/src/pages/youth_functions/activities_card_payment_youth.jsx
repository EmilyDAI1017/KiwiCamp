...
const ActivityCardPaymentYouth = () => {
    ...
    const handleCardPayment = () => {
        ...
        axios.post('http://localhost:3000/campers/activities/card_payment', paymentData)
            .then(response => {
                alert('Payment successfully processed');
                navigate(`/youth_camper_functions/campers_success_pay/${user_id}`, { state: { user_id, group_name: activity_names, camp_name: camp_id } });
            })
            .catch(error => {
...
export default ActivityCardPaymentYouth;
