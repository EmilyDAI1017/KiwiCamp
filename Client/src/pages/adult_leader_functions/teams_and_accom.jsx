...
const TeamsAndAccommodationsAL = () => {
    ...
    const fetchData = async () => {
        try {
            const response = await axios.get(`http://localhost:3000/adult_leaders/team_accommodation/${user_id}`);
...
export default TeamsAndAccommodationsAL;
