...
const CampersCardPayment = () => {
    const location = useLocation();
    const navigate = useNavigate();
    const { camp_name, camp_id, group_name, user_id, group_id, paymentId,registration_id, finalPrice} = location.state;
    ...
    const handleCardPayment = () => {
        ...
        axios.post('http://localhost:3000/campers/card_payment', paymentData)
            .then(response => {
                ...
                console.log(group_name, camp_name, user_id);
    ...
    return (
        <div className="main-content">
            ...
            <div className="payment-details">
                ...
                <p>Payment for Camp : {camp_name}</p>
                </div>
            <div className="payment-details">
                <input
                    type="text"
...
export default CampersCardPayment;
