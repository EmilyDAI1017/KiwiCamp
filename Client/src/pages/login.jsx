...
export default function Login(){
    ...
    return (
        <div class="main-content mt-11 bg-cover dark:bg-neutral-700" style={{ backgroundImage: "url('/src/images/login.jpg')" }}>

        <div className="min-h-screen flex items-center justify-center" >
            <div className="max-w-md w-full bg-white/70 shadow-lg rounded-lg p-8" >
                <h1 className="text-2xl font-semibold text-center text-green-700 mb-6">Welcome to Kiwi Camp</h1>

            <form onSubmit={handleSubmit} className="space-y-6">
                <label              
                 class="peer block min-h-[auto] w-full text-1.5xl rounded border-0 bg-transparent px-3 py-[0.32rem] leading-[2.15] outline-none transition-all duration-200 ease-linear focus:placeholder:opacity-100 peer-focus:text-primary data-[twe-input-state-active]:placeholder:opacity-100 motion-reduce:transition-none dark:text-white dark:placeholder:text-neutral-300 dark:autofill:shadow-autofill dark:peer-focus:text-primary [&:not([data-twe-input-placeholder-active])]:placeholder:opacity-0"
                >               
                Username:</label>
                <input type="text" 
                name="username" 
                ...
                class="bg-gray-50 border border-gray-300 text-1xl text-gray-900  rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                required 
                />
                <label 
                className="block mb-2 text-1xl font-medium text-gray-900 dark:text-white"
                >
                Password:</label>
                <input 
                type={pwdHidden} 
...
<p className="text-1xl font-light text-gray-500 dark:text-gray-400">
          Don’t have an account yet? 
          <Link to="/register" className="font-medium text-blue-600 hover:underline dark:text-blue-500"> Sign up</Link>
        </p>
                <Button type="submit" className="w-full bg-green-600 hover:bg-green-700 text-1xl font-serif text-white py-2 px-4 rounded">Login</Button>
                <br />
